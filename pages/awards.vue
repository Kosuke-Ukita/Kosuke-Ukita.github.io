...
<template>
  <div>
    <h1 class="font-mono font-semibold text-gray-900 dark:text-zinc-100 text-xl mb-8 tracking-tight">Awards</h1>
      ...
      <ul class="space-y-4">
        <li v-for="(item, i) in group.items" :key="i" class="flex gap-1 text-sm">
          ...
          <div>
            ...
            <p class="text-[0.72rem] text-gray-400 dark:text-zinc-500 font-mono">{{ item.organization }}</p>
